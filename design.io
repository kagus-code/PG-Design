...
<mxGraphModel dx="1231" dy="641" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
  <root>
    ...
    <mxCell id="edge3" edge="1" parent="1" source="payment_service" target="subscription_service">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    
    <mxCell id="edge4" edge="1" parent="1" source="subscription_service" target="payment_db">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    
    <mxCell id="edge5" edge="1" parent="1" source="payment_service" target="notification_service">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    
    <mxCell id="edge6" edge="1" parent="1" source="payment_service" target="verification_service">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    
    <mxCell id="edge7" edge="1" parent="1" source="admin_dashboard" target="payment_db">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
  </root>
</mxGraphModel>
